    ...
    def __init__(self,task):
        if task == "submit":
            self.para = {"Spin":None,"L":{"L1":None,"L2":None,"dL":None},"J":{"J1":None,"J2":None,"dJ":None},\
                 ...
                 "BC":None,"Pdis":None,"bondDim":None,"check_Or_Not":None,"Ncore":None,"partition1":None,"task":"submit"}

        elif task == "show":
            self.para = {"Spin":None,"L":{"L1":None,"L2":None,"dL":None},"J":{"J1":None,"J2":None,"dJ":None},\
                 "D":{"D1":None,"D2":None,"dD":None},"seed":{"S1":None,"S2":None,"dS":None},\
                 "BC":None,"Pdis":None,"bondDim":None,"status":None,"Ncore":None,"partition1":None,"task":"show"}

        elif task == "cancel":
            self.para = {"Spin":None,"L":{"L1":None,"L2":None,"dL":None},"J":{"J1":None,"J2":None,"dJ":None},\
                 "D":{"D1":None,"D2":None,"dD":None},"seed":{"S1":None,"S2":None,"dS":None},\
                 "BC":None,"Pdis":None,"bondDim":None,"status":None,"Ncore":None,"partition1":None,"task":"cancel"}

        elif task == "change":
            self.para = {"Spin":None,"L":{"L1":None,"L2":None,"dL":None},"J":{"J1":None,"J2":None,"dJ":None},\
                 "D":{"D1":None,"D2":None,"dD":None},"seed":{"S1":None,"S2":None,"dS":None},\
                 "BC":None,"Pdis":None,"bondDim":None,"check_Or_Not":None,"status":None,"Ncore":None,"partition1":None,"partition2":None}
            ...
            self.resubmit = {"Spin":None,"L":{"L1":None,"L2":None,"dL":None},"J":{"J1":None,"J2":None,"dJ":None},\
                 "D":{"D1":None,"D2":None,"dD":None},"seed":{"S1":None,"S2":None,"dS":None},\
                 "BC":None,"Pdis":None,"bondDim":None,"check_Or_Not":None,"Ncore":None,"partition1":None,"task":"resubmit"}
            
        elif task == "dis":
            self.para = {"Spin":None,"L":{"L1":None,"L2":None,"dL":None},"J":{"J1":None,"J2":None,"dJ":None},\
                 "D":{"D1":None,"D2":None,"dD":None},"seed":{"S1":None,"S2":None,"dS":None},\
                 "BC":None,"Pdis":None,"bondDim":None,"status":None,"Ncore":None,"partition1":None,"task":"dis"}
    def keyin(self):
    ...
    def set_Pdis(self):
        ...
        while(Pdis not in {"10","20","30"}):
            ...
            if Pdis == "":
                ...
                return
        self.para["Pdis"] = Pdis
    def set_bondDim(self):
        try:
            bondDim = input("bondDim? : \n")
            bondDim = int(bondDim)
        except ValueError: 
            if bondDim == "":
                self.para["bondDim"] = "skip"
                return
            else:
                print("only int")
                self.set_bondDim()
        self.para["bondDim"] = bondDim
